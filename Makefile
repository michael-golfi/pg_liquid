...
DEPS = $(OBJS:.o=.d)
EXTENSION = pg_liquid
DATA = sql/pg_liquid--0.1.0.sql sql/pg_liquid--1.0.sql sql/pg_liquid--1.0.0.sql sql/pg_liquid--1.1.sql \
	sql/pg_liquid--1.1.0.sql sql/pg_liquid--1.2.sql sql/pg_liquid--1.2.0.sql sql/pg_liquid--1.0--1.0.0.sql \
	sql/pg_liquid--1.0--1.1.sql sql/pg_liquid--1.0--0.1.0.sql sql/pg_liquid--1.0.0--1.1.0.sql \
	sql/pg_liquid--1.0.0--0.1.0.sql sql/pg_liquid--1.1--1.1.0.sql sql/pg_liquid--1.1--1.2.sql \
	sql/pg_liquid--1.1--0.1.0.sql sql/pg_liquid--1.1.0--1.2.0.sql sql/pg_liquid--1.1.0--0.1.0.sql \
	sql/pg_liquid--1.2--1.2.0.sql sql/pg_liquid--1.2--0.1.0.sql sql/pg_liquid--1.2.0--0.1.0.sql
