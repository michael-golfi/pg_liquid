...
READ_AS_LOOKUP_MAX_MS="${READ_AS_LOOKUP_MAX_MS:-1200}"
ROW_NORMALIZER_BACKFILL_MAX_MS="${ROW_NORMALIZER_BACKFILL_MAX_MS:-4000}"
ROW_NORMALIZER_TRIGGER_INSERT_MAX_MS="${ROW_NORMALIZER_TRIGGER_INSERT_MAX_MS:-1500}"
ROW_NORMALIZER_TRIGGER_UPDATE_MAX_MS="${ROW_NORMALIZER_TRIGGER_UPDATE_MAX_MS:-1500}"
ROW_NORMALIZER_TRIGGER_DELETE_MAX_MS="${ROW_NORMALIZER_TRIGGER_DELETE_MAX_MS:-1500}"
ONTOLOGY_VALIDATION_MAX_MS="${ONTOLOGY_VALIDATION_MAX_MS:-2000}"
...
assert_metric "read_as_lookup_ms" "$READ_AS_LOOKUP_MAX_MS"
assert_metric "row_normalizer_backfill_ms" "$ROW_NORMALIZER_BACKFILL_MAX_MS"
assert_metric "row_normalizer_trigger_insert_ms" "$ROW_NORMALIZER_TRIGGER_INSERT_MAX_MS"
assert_metric "row_normalizer_trigger_update_ms" "$ROW_NORMALIZER_TRIGGER_UPDATE_MAX_MS"
assert_metric "row_normalizer_trigger_delete_ms" "$ROW_NORMALIZER_TRIGGER_DELETE_MAX_MS"
assert_metric "ontology_validation_ms" "$ONTOLOGY_VALIDATION_MAX_MS"
